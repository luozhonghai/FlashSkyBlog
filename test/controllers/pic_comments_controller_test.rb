...
class PicCommentsControllerTest < ActionController::TestCase
  ...
  test "should create pic_comment" do
    assert_difference('PicComment.count') do
      post :create, pic_comment: { description: @pic_comment.description, picture_id: @pic_comment.picture_id, user: @pic_comment.user, user_id: @pic_comment.user_id }
    end
  ...
  test "should update pic_comment" do
    patch :update, id: @pic_comment, pic_comment: { description: @pic_comment.description, picture_id: @pic_comment.picture_id, user: @pic_comment.user, user_id: @pic_comment.user_id }
    assert_redirected_to pic_comment_path(assigns(:pic_comment))
  end
